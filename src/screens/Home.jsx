  ...
  return (
    <>
      <div className="w-8/12 border border-amber-500 shadow-md rounded p-6 mx-auto mt-20 flex flex-col items-center">
        ...
        <input type="text" placeholder='Secret Code (Dtisau)' value={secretcode} onChange={(e) => setSecretcode(e.target.value)} className='p-2 border border-b-fuchsia-600 mt-6 rounded w-100' />
